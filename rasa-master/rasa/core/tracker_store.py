...
class InMemoryTrackerStore(TrackerStore):
    ...
    def save(self, tracker: DialogueStateTracker) -> None:
        ...
        datas = {"chatbot_id":11, "sender_id":tracker.sender_id, "sender_message":tracker.latest_message.text, "chatbot_message":bot_reply, "user_intent":user_intent, "chatbot_utter":chatbot_utter, "date":date}
        headers = {'Content-type': 'application/json'}
        rsp = requests.post(url, json=datas, headers=headers)
        # print("Hakuna matata")
        # print("This is the follow up action")
        # print(tracker.data)
